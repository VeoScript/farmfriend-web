          ...
          <div className="flex flex-col md:flex-row items-center w-full space-x-0 md:space-x-5 space-y-3 md:space-y-0">
            <div className="flex flex-col items-center w-full p-5 shadow-xl rounded-xl border border-olive-semi-light bg-yellow-green bg-opacity-50">
              ...
              <div className="flex flex-col items-center w-full space-y-1">
                <h1 className="font-bold text-center text-xl text-olive">Gayle Marie Dela Torre</h1>
            ...
            <div className="flex flex-col items-center w-full p-5 shadow-xl rounded-xl border border-olive-semi-light bg-yellow-green bg-opacity-50">
              ...
              />
              <div className="flex flex-col items-center w-full space-y-1">
                <h1 className="font-bold text-center text-xl text-olive">Joyce Mae Catubig</h1>
                <h2 className="font-bold text-base text-olive">BSIT - 4</h2>
            ...
            <div className="flex flex-col items-center w-full p-5 shadow-xl rounded-xl border border-olive-semi-light bg-yellow-green bg-opacity-50">
              ...
              />
              <div className="flex flex-col items-center w-full space-y-1">
                <h1 className="font-bold text-center text-xl text-olive">Mark James Miquiabas</h1>
                <h2 className="font-bold text-base text-olive">BSIT - 4</h2>
